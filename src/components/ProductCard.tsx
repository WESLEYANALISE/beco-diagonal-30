            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-2">
                  ...
                  <Button size="sm" className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold text-xs" onClick={handleBuyClick}>
  ...
  return <>
      <Card id={`product-${product.id}`} style={style} className={`
        ...
        <CardContent className={compact ? "p-2" : "p-3"}>
          <h3 className={`font-medium text-gray-900 mb-2 line-clamp-2 hover:text-red-600 transition-colors ${compact ? 'text-xs leading-tight' : 'text-sm'}`}>
            {product.produto}
          </h3>
          ...
          <div className="space-y-1">
            ...
            <Button size="sm" className={`w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold text-xs hover:scale-105 transition-all duration-300 ${compact ? 'py-1' : ''}`} onClick={handleBuyClick}>
              <ShoppingCart className="w-3 h-3 mr-1" />
              Comprar na Shopee
            </Button>
          </div>
