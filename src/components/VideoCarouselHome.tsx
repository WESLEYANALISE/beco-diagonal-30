  ...
  return <div className="group relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
      ...
      <div className="relative aspect-video bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <Button onClick={() => onWatchVideo(product)} className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/30 rounded-full p-4" size="sm">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onWatchVideo(product)} variant="outline" size="sm" className="flex-1 border-orange-500 text-orange-600 hover:bg-orange-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[...Array(4)].map((_, i) => <div key={i} className="h-64 bg-white/20 rounded-2xl"></div>)}
            </div>
          </div>
        </div>
      </section>;
