    ...
    <div className="relative w-full h-full bg-magical-midnight overflow-hidden">
      ...
      <div className="absolute bottom-20 left-4 right-4 z-20">
        <div className="bg-magical-midnight/80 backdrop-blur-sm rounded-2xl p-4 border border-magical-gold/30 shadow-2xl">
          <h3 className="text-magical-starlight font-bold text-lg mb-2 line-clamp-2 font-magical">
            {title}
          </h3>
          <div className="flex items-center justify-between mb-3">
            <span className="text-magical-gold font-bold text-xl font-magical">{price}</span>
          ...
          <Button 
            onClick={onBuy}
            className="w-full bg-gradient-to-r from-magical-gold to-magical-bronze text-magical-midnight hover:from-magical-darkGold hover:to-magical-bronze font-semibold transition-all duration-300 hover:scale-105 font-enchanted shadow-lg"
          >
